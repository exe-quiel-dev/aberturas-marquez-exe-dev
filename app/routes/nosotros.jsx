  ...
  return (
    <main className="flex flex-col items-center justify-center px-6 py-20 min-h-screen">
      ...
      <div className=" bg-gray-100 p-4 md:p-10 my-5 rounded-lg shadow-md w-full md:w-1/2">
        ...
        <h3 className="text-start uppercase text-lg md:text-xl lg:text-2xl font-bold underline">Contacto</h3>
        <p className="text-lg py-4 font-semibold text-start">Whatsapp: 11-6816-4079 ( Ezequiel )</p>
        <p className="text-lg py-4 font-semibold text-start">Instagram: @Aberturas_Marquez</p>
      </div>
    </main>
  )
}
