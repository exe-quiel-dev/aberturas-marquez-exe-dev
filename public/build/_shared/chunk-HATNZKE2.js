...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1691420247592.844";
}
var Card = ({
  nombre,
  marco,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1691420406340.4722";
}
var Categorias = ({
  children,
  categoria,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { className: "min-h-screen bg-categorias py-10 border-b border-gray-300 flex flex-col items-center", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center justify-items-center gap-4 w-full min-h-screen bg-black/50 py-10 px-5 rounded container mx-auto", children }, void 0, false, {
      fileName: "app/components/categorias.jsx",
      lineNumber: 29,
      columnNumber: 7
    }, this)
...
//# sourceMappingURL=/build/_shared/chunk-HATNZKE2.js.map
