...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1691420442941.9607";
}
function CategoriasPvc({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { className: "min-h-screen bg-categorias py-10 border-b border-gray-300 flex flex-col items-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h1", { className: "uppercase text-3xl md:text-4xl font-black mb-4 text-white text-center w-full drop-shadow", children: categoria }, void 0, false, {
      fileName: "app/components/categoriasPvc.jsx",
      lineNumber: 28,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h3", { className: "uppercase text-3xl md:text-4xl font-black mb-4 text-amber-400 text-center w-full drop-shadow-sm", children: subcategoria }, void 0, false, {
      fileName: "app/components/categoriasPvc.jsx",
      lineNumber: 29,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items center justify-items-center gap-4 w-11/12 min-h-screen bg-black/50 py-10 px-5 rounded", children }, void 0, false, {
      fileName: "app/components/categoriasPvc.jsx",
      lineNumber: 30,
      columnNumber: 7
    }, this)
...
//# sourceMappingURL=/build/_shared/chunk-CFCHPMEZ.js.map
