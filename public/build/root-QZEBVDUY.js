...
var styles_default = "/build/_assets/index-ALRAZXZR.css";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1693780173638.8518";
}
function Nav() {
  _s();
  const location = useLocation();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("nav", { className: "w-full text-white flex justify-between items-center text-lg font-light py-0 px-4 flex-wrap gap-4", children: [
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1694049472257.3325";
}
function Header() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("header", { className: "flex flex-col md:flex-row items-center justify-center bg-slate-900/50 py-2 border-b border-gray-300 sticky top-0 w-full z-10", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-1/3 text-white flex items-center justify-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { href: "https://wa.me/541168164079", target: "_blank", rel: "noreferrer", alt: "Logotipo whatsapp", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(AiOutlineWhatsApp, { className: "mx-2 w-6 h-6 hover:text-green-500 transition-colors hover:cursor-pointer" }, void 0, false, {
        fileName: "app/components/header.jsx",
        lineNumber: 37,
        columnNumber: 103
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { href: "https://www.facebook.com/aberturas.marquez.3?mibextid=ZbWKwL", target: "_blank", rel: "noreferrer", alt: "Logotipo facebook", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(AiOutlineFacebook, { className: "mx-2 w-6 h-6 hover:text-blue-600 transition-colors hover:cursor-pointer" }, void 0, false, {
        fileName: "app/components/header.jsx",
        lineNumber: 38,
        columnNumber: 137
      }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/root-QZEBVDUY.js.map
