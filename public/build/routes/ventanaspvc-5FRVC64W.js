...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1691424030854.1926";
}
var ventanasPvc = [
  {
    id: 1,
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\ventanaspvc.jsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1693047756147.9604";
}
function meta() {
  return [{
    charset: "utf-8"
...
function VentanasPvc() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(categoriasPvc_default, { children: ventanasPvc.map((ventana) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(cardpvc_default, { nombre: ventana.nombre, info: ventana.info, img: ventana.img }, void 0, false, {
...
//# sourceMappingURL=/build/routes/ventanaspvc-5FRVC64W.js.map
