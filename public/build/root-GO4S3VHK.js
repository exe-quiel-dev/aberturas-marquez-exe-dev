...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1691094694654.942";
}
function Header() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("header", { className: "flex flex-col md:flex-row items-center justify-center bg-black/50 py-5 border-b border-gray-300 sticky top-0 w-full", children: [
...
function Document({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("html", { lang: "es", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("body", { className: "bg-gray-400", children: [
...
//# sourceMappingURL=/build/root-GO4S3VHK.js.map
